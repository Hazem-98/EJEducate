const coursData = [
    {
      ...
      title: 'DEV WEB',
      location: 'Tunisia',
      image: require('../../src/images/web.jpg'),
      imageBig: require('../../src/images/web.jpg'),
      description:
    ...
    },
    {
      ...
      title: 'Mobile',
      location: 'Tunisia',
      image: require('../../src/images/code.jpg'),
      imageBig: require('../../src/images/code.jpg'),
      description:
    ...
    },
    {
        ...
        title: 'IA',
        location: 'Tunisia',
        image: require('../../src/images/ensi.png'),
        imageBig: require('../../src/images/ensi.png'),
        description:
          'Great day hikes and backpacking routes on the North and South Rim of this century-old national park include easy hikes overlooking the rim and more rugged trekking options that descend into the canyon.',
        liked: true,
        price: 350,
      ...
      },
      {
        ...
        title: 'ML',
        location: 'Tunisia',
        image: require('../../src/images/Coursera.jpg'),
        imageBig: require('../../src/images/Coursera.jpg'),
        description:
          'Great day hikes and backpacking routes on the North and South Rim of this century-old national park include easy hikes overlooking the rim and more rugged trekking options that descend into the canyon.',
        liked: true,
        price: 350,
